...
class M_perum extends CI_Model
{
    ...
    function m_simpan_perum($nm_perum, $kode_perum, $alamat, $map,  $url_map, $deskripsi, $logo, $video)
    {
        $data = array(
            'nm_perum' => $nm_perum,
    ...
    function m_edit_perum($id_perum, $nm_perum, $kode_perum, $alamat, $map,  $url_map, $deskripsi, $video)
    {
    ...
    function m_edit_logo_perum($id_perum, $nm_perum, $kode_perum, $alamat, $map,  $url_map, $deskripsi, $logo, $video)
    {
        $update = $this->db->set('nm_perum', $nm_perum)
            ->set('kode_perum', $kode_perum)
            ->set('alamat', $alamat)
