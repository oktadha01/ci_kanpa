                ...
                <div class="swiper-wrapper ">
                    <div class="swiper-slide">
                        <a href="<?php echo base_url('Kategori'); ?>/perumahan/subsidi">
                            <center>
                                <img src="<?php echo base_url('upload'); ?>/header-SUBSIDI.png" class="img-fluid"
                                    alt="">
                            </center>
                        </a>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <a
                            href="<?php echo base_url('detail'); ?>/perum/<?php echo $tittle; ?>/tipe/<?php echo $tipe_perum->luas_bangunan; ?>/<?php echo $tipe_perum->luas_tanah; ?>">
                            <center>
                                <img src="<?php echo base_url('upload'); ?>/<?php echo $data->header_foto; ?>"
                                    class="img-fluid" alt="">
                            </center>
                        </a>
                    </div>
                        ...
                        <div class="m-2">
                            ...
                            <a
                                ...
                                <button type="button" id=""
                                    class="btn btn-sm mb-2 btn-outline-info"><?php echo $tipe->luas_bangunan; ?>/<?php echo $tipe->luas_tanah; ?></button>
                            </a>
                            <?php
                                    }
                                }
                                ...
                                <div class="form-group">
                                    <a class="text-dark add-view-news"
                                        ...
                                        <img src="<?php echo base_url('upload'); ?>/<?php echo $data->foto_berita; ?>"
                                            srcset="<?php echo base_url('upload'); ?>/<?php echo $data->foto_berita; ?> 1x, <?php echo base_url('upload'); ?>/<?php echo $data->foto_berita; ?> 10x"
