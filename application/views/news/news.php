         ...
         <div class="row">
            <div class="col-lg-3 col-3">
               ...
               ?>
                  ...
                  <h6 class="text-publishing"><?php echo $data->tgl_berita; ?></h6>
                  <h6 id="tittle-berita<?php echo $data->id_berita; ?>" data-id-berita="<?php echo $data->id_berita; ?>" class="tittle-news tittle<?php echo $data->id_berita; ?>"><?php echo $data->judul_berita; ?></h6>
                  <div id="konten-berita<?php echo $data->id_berita; ?>" class="mt-1 p-1 konten<?php echo $data->id_berita; ?> konten" hidden>
                     <p class="text-konten-news"><?php echo $data->desk_berita; ?></p>
                  </div>
                  <h6 class="font-text-port"><?php echo $data->view_berita; ?> views</h6>
            ...
            <div class="col-lg-9 col-9">
               ...
               Bantuan perbaikan jalan PT. KANPA
               Perluasan dan pelebaran jalan oleh PT. KANPA di Desa Kalisidi, Ungaran Barat, Kabupaten Semarang dilakukan sebagai upaya untuk membantu warga sekitar. Jalan aspal di Desa Kalisidi yang semula menyulitkan pengendara saat berpapasan, kini sudah mudah dilalui karena bertambah 1 meter. Dampak pelebaran jalan ini sudah bisa dirasakan oleh penguna jalan roda dua maupun roda empat.
            </div>
         </div>
         <hr>
         <div class="row">
               ...
               <div class="col-lg-6 col-12 " data-aos="zoom-in" data-aos-delay="<?php echo $no++; ?>00">
                  <div class="border-radius">
                     <div class="row">
                        ...
                        <div class="col-lg-8 col-md-9 col-12 p-3">
                           <h6 class="text-publishing"><?php echo $data->tgl_berita; ?></h6>
                           <h6 id="tittle-berita<?php echo $data->id_berita; ?>" data-id-berita="<?php echo $data->id_berita; ?>" class="tittle-news tittle<?php echo $data->id_berita; ?>"><?php echo $data->judul_berita; ?></h6>
                           <div id="konten-berita<?php echo $data->id_berita; ?>" class="mt-1 p-1 konten<?php echo $data->id_berita; ?> konten" hidden>
                              <p class="text-konten-news"><?php echo $data->desk_berita; ?></p>
